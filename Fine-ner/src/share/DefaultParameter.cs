...
namespace msra.nlp.tr
{
    class DefaultParameter
    {
        public struct Field
        {
            ...
            public const string activateParser                = "activeParser";
            public const string activateNer                   = "activeNer";
            public const string activateDbpedia               = "activeDbpedia";
            public const string activateMIKeyword             = "activeDbpedia";
        };
